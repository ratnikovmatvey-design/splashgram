...
#ifdef OS_WIN_STORE
const WCHAR AppUserModelIdBase[] = L"Splashgram.SplashgramDesktop.Store";
#else // OS_WIN_STORE
const WCHAR AppUserModelIdBase[] = L"Splashgram.SplashgramDesktop";
#endif // OS_WIN_STORE
...
void CleanupShortcut() {
	...
	QString path = systemShortcutPath() + u"Splashgram.lnk"_q;
...
bool checkInstalled(QString path = {}) {
	...
	const auto installed = u"Splashgram Desktop/Splashgram.lnk"_q;
	const auto old = u"Splashgram for Windows/Splashgram.lnk"_q;
